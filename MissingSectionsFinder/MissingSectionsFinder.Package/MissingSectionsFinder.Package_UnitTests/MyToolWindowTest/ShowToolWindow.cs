...
using OmarSalem.MissingSectionsFinder_Package;

namespace MissingSectionsFinder.Package_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new MissingSectionsFinder_PackagePackage() as IVsPackage;
            ...
            MethodInfo method = typeof(MissingSectionsFinder_PackagePackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
